sealed class Tree<out A: Comparable<@UnsafeVariance A>> {
    ...
    internal val B = Color.B
    internal val R = Color.R
    internal val BB = Color.BB
    internal val NB = Color.NB
    ...
    private val g: (List<A>) -> (List<A>) -> List<A> = { a -> { b -> List.concat(a, b) } }
    private val f: (List<A>) -> (A) -> List<A> = { l -> { a ->  List.cons(a, l) } }
